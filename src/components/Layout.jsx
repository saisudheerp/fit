        ...
        <div style={{
          ...
          >
            <div style={{
              ...
              <span className="material-icons" style={{ fontSize: '28px', color: '#000' }}>fitness_center</span>
            </div>
            <h1 style={{
            ...
            {navItems.map((item) => (
              <Link
                ...
                style={{
                  ...
                  boxShadow: isActive(item.path) ? '0 4px 12px rgba(102, 126, 234, 0.4)' : 'none'
                }}
                onMouseEnter={(e) => {
          ...
          <button
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.background = 'linear-gradient(135deg, #f093fb20 0%, #f5576c20 100%)';
      ...
      <footer style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span className="material-icons" style={{ fontSize: '16px' }}>fitness_center</span>
            <span>FitTrack © 2025</span>
          </div>
          <div style={{ display: 'flex', gap: '24px' }}>
            <a href="#" style={{ color: '#666', fontSize: '13px', textDecoration: 'none' }}>About</a>
            <a href="#" style={{ color: '#666', fontSize: '13px', textDecoration: 'none' }}>Privacy</a>
            <a href="https://github.com" style={{ color: '#666', fontSize: '13px', textDecoration: 'none' }}>GitHub</a>
          </div>
        </div>
      </footer>
    </div>
